...
buildmenu:function($, setting){
	var $cms_path = setting.cms_path
	var $submenu_images = setting.submenu_images
	...
	$headers.each(function(i){ //loop through each LI header
		...
		$curobj.children("a:eq(0)").css(this.istopheader? {paddingRight: smoothmenu.arrowimages.down[2]} : {}
			...
			'<img src="'+$cms_path + (this.istopheader && setting.orientation!='v'? smoothmenu.arrowimages.down[1] : smoothmenu.arrowimages.right[1])
